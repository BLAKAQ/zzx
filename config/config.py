...
OWNER_ID = list(map(int, getenv("OWNER_ID", "7094651211 7094651211").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/A1DIIU")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/bd4a8c4bf9ad5f107a3d3.jpg"
)
